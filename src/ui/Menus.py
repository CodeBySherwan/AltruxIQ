...
#  BEAM-FEA DOMAIN UI
# -----------------------------------------------------------------------------
#  Menus, profile/analysis renderers and engineering recommendation reports.
#  The generic terminal kit (widgets, prompts, formatters, session clock) now
#  lives in ``ui.console``; this module keeps only the beam-domain screens
#  built on top of it. Extracted during the P3 ``console/`` decomposition.
# =============================================================================
