...
# -----------------------------------------------------------------------------
#  Interactive domain wizards: beam classification, geometry, supports, loads,
#  materials and stepped segments. Built on the generic prompt toolkit and
#  console widgets now living in ``ui.console``. The prompt primitives
#  themselves moved to ``ui.console`` during the P3 decomposition; they are
#  imported here only because the beam wizards below call them directly.
# =============================================================================
...
def define_stepped_segments(unit_system="Metric", units=None):
    ...
    # Kit helpers (print_*/clear_screen) already imported at module top.
